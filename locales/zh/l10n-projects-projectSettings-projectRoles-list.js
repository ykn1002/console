...
module.exports = {
  ...
  PERMISSION_SERVICEACCOUNT_VIEW: '服务账户查看',
  PERMISSION_SERVICEACCOUNT_VIEW_DESC: '查看项目中的服务账户。',
  PERMISSION_SERVICEACCOUNT_MANAGEMENT: '服务账户管理',
  PERMISSION_SERVICEACCOUNT_MANAGEMENT_DESC: '创建、编辑和删除项目中的服务账户。',
  // List > Edit Permissions > Monitoring & Alerting
  PERMIGROUP_MONITORING_ALERTING: '监控',
  ...
  PERMISSION_PROJECT_SETTINGS_DESC: '管理项目设置，包括项目基本信息、外部访问设置、网络策略、资源配额、日志收集设置等。',
  // List > Delete
  DELETE_ROLE: '删除角色',
